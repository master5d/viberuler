...
describe('buildPayload', () => {
  ...
  it('leaks nothing beyond the fixed key set (privacy contract)', () => {
    ...
    expect(Object.keys(p).sort()).toEqual([
      'achievements', 'agents', 'breakdown', 'client_version', 'cost_usd',
      'loc', 'projects', 'streak_days', 'tok_per_loc', 'tok_per_usd', 'tokens', 'vibe_score',
    ]);
  ...
  it('includes tok_per_loc (rounded, null-safe); twelve fields total', () => {
  ...
  it('carries streak_days and agent names through from stats', () => {
